...
function(llvm_link_bc_targets)
    ...
    if(NOT TRGT)
        message(FATAL_ERROR "llvm_link_bc_targets: missing TARGET option")
    endif()

    if(NOT DEP_TRGTS)
        message(FATAL_ERROR "llvm_link_bc_targets: missing DEPENDS option")
    endif()
    ...
    if(NOT EXISTS "${WORK_DIR}")
        ...
        if(NOT EXISTS "${WORK_DIR}")
            message(FATAL_ERROR 
                "[llvm_link_bc_targets]: failed to create directory ${WORK_DIR}"
            )
        endif()
    endif()
    set(OUTPUT_FILENAME "${TRGT}.${LLVM_BC_FILE_SUFFIX}")
