...
macro(llvmir_setup)
    ...
    if (NOT DEFINED LLVM_EXTRACTER)
        set(LLVM_EXTRACTER ${LLVM_BIN}/llvm-extract)
    endif()
...
function(extract_header_files out_header_files target)
    set(header_files "")
    set(header_exts ".h;.hh;.hpp;.h++;.hxx")
    get_target_property(src_files ${target} SOURCES)
    foreach(src_file ${src_files})
        get_filename_component(ext ${src_file} EXT)
        if(ext IN_LIST header_exts)
            list(APPEND header_files ${src_file})
        endif()
    endforeach()
    set(${out_header_files} ${header_files} PARENT_SCOPE)
endfunction()
